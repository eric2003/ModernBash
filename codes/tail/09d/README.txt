...
eric@eric-virtual-machine:~/work/bash_work/ModernBash/codes/tail/09d$ bash testprj.sh 
eric@eric-virtual-machine:~/work/bash_work/ModernBash/codes/tail/09d$ ls
list.txt  README.txt  state.txt  testprj.sh
eric@eric-virtual-machine:~/work/bash_work/ModernBash/codes/tail/09d$ cat list.txt 
Manipur
Meghalaya
Mizoram
Nagaland
