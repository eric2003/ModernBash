...
eric@DELL MINGW64 /d/work/bash_work/ModernBash/codes/bash-variables/BASH_LINENO/01 (main)
$ bash testprj.sh
${BASH_LINENO}: 0
${BASH_LINENO}: 0
${BASH_LINENO}: 0
eric@eric-virtual-machine:~/work/bash_work/ModernBash/codes/bash-variables/BASH_LINENO/01$ bash testprj.sh
${BASH_LINENO}: 0
${BASH_LINENO}: 0
${BASH_LINENO}: 0
