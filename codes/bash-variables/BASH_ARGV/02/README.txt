...
eric@DELL MINGW64 /d/work/bash_work/ModernBash/codes/bash-variables/BASH_ARGV/02 (main)
$ bash testprj.sh
${BASH_ARGV[0]}:
...
eric@eric-virtual-machine:~/work/bash_work/ModernBash/codes/bash-variables/BASH_ARGV/02$ bash testprj.sh 
${BASH_ARGV[0]}: 
eric@eric-virtual-machine:~/work/bash_work/ModernBash/codes/bash-variables/BASH_ARGV/02$ bash testprj.sh 1
${BASH_ARGV[0]}: 1
eric@eric-virtual-machine:~/work/bash_work/ModernBash/codes/bash-variables/BASH_ARGV/02$ bash testprj.sh 1 2
${BASH_ARGV[0]}: 2
eric@eric-virtual-machine:~/work/bash_work/ModernBash/codes/bash-variables/BASH_ARGV/02$ bash testprj.sh 1 2 3
${BASH_ARGV[0]}: 3
